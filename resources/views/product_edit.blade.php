...
@section('body-class', 'product_edit-page')
...
<body class="sidebar-mini skin-black-light fixed">
  <div class="wrapper">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">Edit Product [342]</h3>
    </div>
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="#" accept-charset="UTF-8">
            <div class="form-group has-feedback ">
              ...
              <input class="form-control" placeholder="Description" name="description" type="text" value="Lorem ipsum dolor sit amet." id="description">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group has-feedback ">
                  ...
                  <input class="form-control" placeholder="Price" name="price" type="text" value="454.00" id="price">
              ...
              <div class="col-md-6">
                <div class="form-group has-feedback ">
                  ...
                  <input class="form-control" placeholder="Price" name="price" type="text" value="725.00" id="price">
                  <span class="glyphicon glyphicon-credit-card form-control-feedback"></span>
                </div>
              </div>
            </div>
