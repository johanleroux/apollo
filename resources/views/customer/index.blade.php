              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 250px;">
                  ...
                  <div class="input-group-btn">
                    ...
                    <a href="{{ action('CustomersController@create') }}" class="btn btn-info" style="margin-left:15px;">Create</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  @forelse ($customers as $customer)
                    <tr>
                      ...
                      <td style="width: 220px">
                        <div class="btn-group">
                          <a href="{{ action('CustomersController@edit', $customer) }}" class="btn btn-xs btn-flat btn-info">Edit</a>
                        </div>
                      </td>
                    </tr>
                  @empty
                    <tr>
                      <td colspan"5">Sorry, but there is no customers on the system.</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
